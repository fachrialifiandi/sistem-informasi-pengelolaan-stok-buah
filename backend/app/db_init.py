...
def init_db():
    # Note: Supabase already provides the 'postgres' database.
    # We skip CREATE DATABASE and just ensure tables exist.
    print("Ensuring database tables exist (Supabase mode)...")
    ...
    try:
        ...
        # Always commit all changes (users, suppliers, fruits, transactions)
        db.commit()
